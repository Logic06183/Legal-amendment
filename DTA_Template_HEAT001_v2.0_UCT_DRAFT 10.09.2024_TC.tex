...
\title{\textbf{UNIVERSITY OF CAPE TOWN\\DATA TRANSFER AGREEMENT\\WITH TRACKED AMENDMENTS}}
\author{}
\date{}
...
(iii) The Data Recipient has requested the Data Provider to transfer the Original Study Data collected by the Data Provider for the study in (i) above for purposes of the Data Recipient using the Original Study Data in the HE\textsuperscript{2}AT Center Research Project 1, titled: \textit{"Individual Participant Data meta-analysis to quantify the impact of high ambient temperatures on maternal and child health in Africa"} (``RP1 Study'') the details of which are set out in \textbf{Annexure "B"} attached hereto.
...
1.10 \textbf{"Core Data Team"} a group of vital personnel within the HE²AT Center Consortium responsible for the initial processing, harmonisation and integration of the Original Study Data;

1.11 \textbf{"Parties\"} shall mean the parties to this Agreement, namely the University of Cape Town and [provider institution]; and the term \textbf{"Party"} shall refer to either of them;
...
1.17 \textbf{"RP1 Study"} shall mean the specific study under the HE\textsuperscript{2}AT Project titled: \textit{"Individual Participant Data meta-analysis to quantify the impact of high ambient temperatures on maternal and child health in Africa"} as more fully described in \textbf{Annexure "B"} attached hereto;

1.18 \textbf{"RP1 Study Data"} shall mean all data resulting from processing of the Original Study Data during the RP1 Study, which includes but is not limited to, RP1 De-identified Data and Consortium Shared Data;
...
1.20 \textbf{"Consortium Shared Data"} means data that has undergone, initial processing, harmonisation and integration and includes, amongst other variables, a limited set of indirect identifiers that are required for the purposes of conducting the RP1 Study analysis as described in \textbf{Annexure "B"}.
...
2.6 The Data Recipient is hereby authorised to transfer and/or share the Consortium Shared Data with the HE\textsuperscript{2}AT Center Consortium members for purposes of conducting the RP1 Study.
...
2.9 Subject to the terms and conditions of this Agreement, the Data Provider grants the Data Recipient and the HE\textsuperscript{2}AT Center Consortium, the non-exclusive right to use the Original Study Data solely for purposes of the RP1 Study. The Data Provider shall be kept informed of any results of the RP1 Study stemming from the use of the Original Study Data.
...
2.19 All ownership, rights, title and interest in and to the RP1 Study Data and any results generated during the RP1 Study shall vest with the HE\textsuperscript{2}AT Center Consortium in accordance with the Data Transfer Agreement entered into between the HE\textsuperscript{2}AT Center Consortium.
